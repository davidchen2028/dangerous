...
export const LEVEL_KEY_CATALOG = Object.freeze([
  ...
  defineKey("level_key_l8", "l8", "Level 8 岩洞系统", "backrooms-level8.html", "l8", trade(130, 65, { hubTarget: true })),
  ...
  defineKey("level_key_sqrt2", "sqrt2", "Level √2", "backrooms-level-sqrt2.html", "sqrt2", trade(125, 60, { hubTarget: true })),
  ...
  defineKey("level_key_l6_1", "l6_1", "Level 6.1 零食室", "backrooms-level6-1.html", "l6_1", { hubTarget: true }),
  ...
  defineKey("level_key_c1623", "c1623", "Level C-1623 二十里面有过量的三十", "backrooms-level-c1623.html", "c1623", trade(155, 75, { hubTarget: true })),
