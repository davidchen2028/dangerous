...
function guideHtml() {
  return (
    ...
    "</div></section>" +
    "<section><h2>五类任务与四种正式职务</h2><ul>" +
    "<li><strong>公开委托</strong>：所有流浪者均可接取，用于熟悉路线、交付和基础巡检；它不是第五种职务。</li>" +
    "<li><strong>" +
    ...
    "</ul><p>任务板按五栏展示，每栏各有 10 条委托。公开栏每次最多挂出 3 条，未加入 M.E.G. 的人看不到职务栏。正式队员只能接取公开委托和自己职务栏的委托；完成对口任务获得 10% 额外积分点。</p>" +
    "<p>KPI 与商店积分分开：普通任务记基础职业贡献，高危任务额外记高危行动，补给和救援任务另记对应履历；同一轮领赏使用唯一事件编号，不会重复记账。</p></section>" +
    "<section><h2>权限与纪律</h2>" +
