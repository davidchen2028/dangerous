...
class ClientPackTests(unittest.TestCase):
    def test_lists_level_scripts_and_skips_sandbox(self):
        ...
        self.assertIn("backrooms-level7.html", files)
        self.assertIn("js/backrooms-level7-world.js", files)
        self.assertIn("backrooms-level81.html", files)
        self.assertIn("js/backrooms-level81.js", files)
        self.assertIn("js/backrooms-level81-world.js", files)
